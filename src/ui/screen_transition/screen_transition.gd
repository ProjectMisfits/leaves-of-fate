...
func _update_pos(pos = null) -> void:
	assert(pos == null or (pos is Vector2), "ScreenTransition: start_transition provided with invalid pos value! Expected null or Vector2")
	input_position = pos
...
func start_transition(transition_type: String, pos = null) -> void:
	$CanvasLayer.show();
