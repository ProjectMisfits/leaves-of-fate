extends "res://src/actors/npc/npc_base/npc_base.gd"
...
func _ready() -> void:
	...
	match SceneManager.current_scene.name:
		...
		"GB_CellarEntrance":
			dialogue_resource = ResourceLoader.load("res://assets/dialogue/dialogue_scripts/2-Ws-Meet-CellarGeneral.dialogue")
			dialogue_start = "start"
